...
------------|-------------------------|-----------
200	| Success – any success scenarios	| For below operations
•	GET /search or GET /dogs
•	PUT /dogs
•	DELETE /dogs
201	| Created |	•	POST /dogs
304	| Not modified |	•	PUT /dogs
400	| Bad request	| For all PUT/DELETE/POST, if service validation fails.
Return custom header with description as what input validation fails.
404	| Not found	| For below operations
•	GET /search or GET /dogs
•	PUT /dogs
•	DELETE /dogs
304	| Not modified	| •	PUT /dogs
409	| Conflict |	Request is already locked, or is being edited
•	PUT /dogs
•	DELETE /dogs
412	| Precondition failed	| For below operations, if lock is not acquired
•	PUT /dogs
•	DELETE /dogs
